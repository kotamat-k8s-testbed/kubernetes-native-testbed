...
from https://github.com/kotamat-k8s-testbed/kubernetes-native-testbed/settings/hooks/new

```
* Payload URL: https://tekton.34.85.56.142.nip.io/event-listener
...
| ---- | -------- | -------- | -------- |
| Image Registry | https://harbor.34.85.56.142.nip.io | admin | admin |
| CI | https://tekton.34.85.56.142.nip.io | NO | NO |
| CD | https://argocd.34.85.56.142.nip.io | NO | NO |
| Object Storage | https://minio.34.85.56.142.nip.io | minio | miniosecret |
| Block/Shared Storage | https://rook.34.85.56.142.nip.io/ | admin | 'kubectl -n rook-ceph get secret rook-ceph-dashboard-password -o jsonpath="{['data']['password']}" | base64 -d' |
| Dashboard | https://dashboard.34.85.56.142.nip.io/ | NO | NO |
| Monitoring | https://grafana.34.85.56.142.nip.io/ | admin | admin |
| Monitoring | https://prometheus.34.85.56.142.nip.io/ | NO | NO |
| Monitoring | https://weave-scope.34.85.56.142.nip.io | NO | NO |
| Alerting | https://alertmanager.34.85.56.142.nip.io/ | NO | NO |
| Search - ES | https://testbed.34.85.56.142.nip.io/search/es | elastic | 'kubectl -n search get secret search-db-es-elastic-user -o jsonpath="{.data.elastic}" | base64 -d' |
| Search - Kibana | https://testbed.34.85.56.142.nip.io/search/kibana | elastic | 'kubectl -n search get secret search-db-es-elastic-user -o jsonpath="{.data.elastic}" | base64 -d' |
| Point - DB | https://yugabyte.34.85.56.142.nip.io/point/master/ | NO | NO |
| Point - DB | https://yugabyte.34.85.56.142.nip.io/point/tserver/ | NO | NO |

* Microservice

| Kind | Endpoint | Username | Password |
| ---- | -------- | -------- | -------- |
| Admin | https://testbed.34.85.56.142.nip.io/admin/ | NO | NO |
...
https://testbed.34.85.56.142.nip.io/admin/index.html
  or
http://localhost:8080/
```
